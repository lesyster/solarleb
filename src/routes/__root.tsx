...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SolvoraLB — Reliable solar power for Lebanon" },
      { name: "description", content: "AI-powered solar planning for Lebanese homes and businesses. Get a free custom recommendation and lock in today's panel prices." },
      { name: "author", content: "SolvoraLB" },
      { property: "og:title", content: "SolvoraLB — Reliable solar power for Lebanon" },
      ...
      { name: "twitter:title", content: "SolvoraLB — Reliable solar power for Lebanon" },
